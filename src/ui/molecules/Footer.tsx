export const Footer = () => {
	return (
		<footer className="mx-auto mt-10 border-t-2 p-12">
			<div className="container mx-auto flex flex-col flex-wrap px-5 pb-24 md:flex-row md:flex-nowrap md:items-center lg:items-start">
